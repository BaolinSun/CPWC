...
pha.points=[0, 0, 60e-3, 1];      % point scatterer position [m]
fig_handle=pha.plot();             
...
scan=uff.sector_scan('azimuth_axis',linspace(-5*pi/180,5*pi/180,128).','depth_axis',linspace(55e-3,65e-3,128).');
...
mid.transmit_apodization.minimum_aperture = 15e-3;
